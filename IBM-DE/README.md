...
## Course Description
This 6-month, self-paced program teaches the job-ready skills needed for data engineering roles, including Python, SQL, Linux/UNIX scripting, relational and NoSQL databases, ETL, data warehousing, big data, Spark, and generative AI.
### Projects
